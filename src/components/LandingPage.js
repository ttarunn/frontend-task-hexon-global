...
const LandingPage = () => {
  ...
  return (
    ...
    <div>
      <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button" onClick={()=> username ? navigate(`/repos/${username}`):alert('Please type username')}>
        Search
      </button>
    </div>
    <Outlet/>
